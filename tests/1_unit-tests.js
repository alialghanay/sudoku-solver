...
suite("Unit Tests", () => {
  suite("validtion", function () {
    ...
    test("Required field(s) missing", function (done) {
      assert.throws(
        () => solver.parmsCheck(pz, unValid, value),
        "Required field(s) missing"
      );
      assert.throws(
        () => solver.parmsCheck(unValid, coordinate, value),
        "Required field(s) missing"
      );
      assert.throws(
        () => solver.parmsCheck(pz, coordinate, unValid),
        "Required field(s) missing"
      );
      assert.throws(
        () => solver.parmsCheck(unValid, unValid, unValid),
        "Required field(s) missing"
      );
      assert.isTrue(true);
      done();
    ...
    test("Invalid value", function (done) {
      assert.throws(
        () => solver.parmsCheck(pz, coordinate, "10"),
        "Invalid value"
      );
      assert.throws(
        () => solver.parmsCheck(pz, coordinate, "-1"),
        "Invalid value"
      );
      assert.throws(
        () => solver.parmsCheck(pz, coordinate, "ABC"),
        "Invalid value"
      );
      assert.throws(
        () => solver.parmsCheck(pz, coordinate, "@*#%"),
        "Invalid value"
      );
      assert.isTrue(true);
      done();
    ...
    test("Invalid coordinate", function (done) {
      assert.throws(
        () => solver.coordinateConverter("55"),
        "Invalid coordinate"
      );
      assert.throws(
        () => solver.coordinateConverter("A10"),
        "Invalid coordinate"
      );
      assert.throws(
        () => solver.coordinateConverter("J10"),
        "Invalid coordinate"
      );
      assert.throws(
        () => solver.coordinateConverter("J9"),
        "Invalid coordinate"
      );
      assert.isTrue(true);
      done();
    ...
    test("Invalid characters in puzzle", function (done) {
      assert.throws(
        () => solver.validate(pz.replace("9", "x")),
        "Invalid characters in puzzle"
      );
      assert.throws(
        () => solver.validate(pz.replace("9", "A")),
        "Invalid characters in puzzle"
      );
      assert.throws(
        () => solver.validate(pz.replace("9", "?")),
